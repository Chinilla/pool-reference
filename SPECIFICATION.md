# Chinilla Pool Protocol 1.0

This is the initial version of the Chinilla Pool Protocol. It is designed to be simple, and to be extended later.
...
The Chinilla client must only connect to the pool configuration URL via HTTPS over TLS >= 1.2. This is to
...
run by the farmer (the default in the Chinilla GUI application), or run by the pool operator. If the farmer does not want
...
[here](https://github.com/Chinilla/chinilla-blockchain/blob/main/chinilla/util/streamable.py).
...
```json
{
    "description": "(example) The Reference Pool allows you to pool with low fees, paying out daily using Chinilla.",
    "fee": 0.01,
    "logo_url": "https://www.chinilla.com/img/chinilla_logo.svg",
...
These are the instructions for how the farmer wants to get paid. By default this will be an HCX address, but it can
...
[pool protocol](https://github.com/Chinilla/chinilla-blockchain/blob/main/chinilla/protocols/pool_protocol.py)
...
[pool protocol](https://github.com/Chinilla/chinilla-blockchain/blob/main/chinilla/protocols/pool_protocol.py) for details
...
The proof of space in chinilla-blockchain format.
